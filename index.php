...
$testArray=
      $trelloUrl=file_get_contents("https://api.trello.com/1/boards/59bbfb5d797862446e2485be/cards?fields=name&key=69d49f5bc3075a4020e73605baf19fa0&token=276714893b502f805946d88f50cd6c22910f354d58c8a4ac2ef2af608385f92d");
      $urlContents = file_get_contents("https://www.rescuetime.com/anapi/data?key=B63z8E5tueMzCDmDjQqaZIyasjuX52PAFiGMj25F&perspective=rank&interval=hour&restrict_begin=".date('Y-m-d')."&restrict_end=".date('Y-m-d')."&format=json");
      $urlContentsY = file_get_contents("https://www.rescuetime.com/anapi/data?key=B63z8E5tueMzCDmDjQqaZIyasjuX52PAFiGMj25F&perspective=rank&interval=hour&restrict_begin=".date('d.m.Y',strtotime("-1 days"))."&restrict_end=".date('d.m.Y',strtotime("-1 days"))."&format=json");
      $urlContents2 = file_get_contents("https://www.rescuetime.com/anapi/daily_summary_feed?key=B63z8E5tueMzCDmDjQqaZIyasjuX52PAFiGMj25F");
